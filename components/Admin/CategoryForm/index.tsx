// O componente CategoryForm tem a responsabilidade de unificar e centralizar toda a lógica para gerênciamento do form para cadastro e edição de uma categoria.
      ...
      <Form className={styles.new_form} onSubmit={handleFormSubmit}>
        ...
        <div className={styles.details_button}>
          ...
          <StyledButton
              ...
              type_button="red"
              onClick={() => {
                // limpando a categoria para edição quando a edição é cancelada para não enviar o icaso seja um cadastro para não dar erro de chave primária
